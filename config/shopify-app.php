...
return [
    ...
    */
    ...
    'webhooks' => [
        [
            'topic' => env('SHOPIFY_WEBHOOK_UNINSTALLED_TOPIC', 'APP_UNINSTALLED'),
            'address' => env('SHOPIFY_WEBHOOK_UNINSTALLED_ADDRESS', 'https://gratefully-infinite-boar.ngrok-free.app/webhook/app-uninstalled')
        ],
        /*
            [
